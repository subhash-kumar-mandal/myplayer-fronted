...
const VinylIcon = forwardRef((
  ...
  const start = async () => {
    ...
    animationControls.current.push(animate(".vinyl-disc", {
      rotate: [0, 360],
    }, {
      duration: 8,
      repeat: Infinity,
    ...
    animationControls.current.push(animate(".center-dot", {
      scale: [1, 1.2, 1],
    }, {
      duration: 1,
      repeat: Infinity,
  ...
  return (
    <motion.svg
      ...
      {/* Center dot */}
      <motion.path className="center-dot" d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />
