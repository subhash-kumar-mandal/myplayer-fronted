   ...
   '
    ...
    '>
                ...
                >
                    ...
                    <button
                        className='  flex  justify-center left-3 items-center absolute bottom-[45%] z-20 h-8 w-8 bg-(--bg-hover1)  rounded-full
                                 hover:scale-[1.09]
                                cursor-pointer
                                transition-all
                                duration-300
                    ...
                    <button
                        className=' absolute flex justify-center items-center right-3 bottom-[45%] z-20 h-8 w-8  bg-(--bg-hover1)  rounded-full transition-all
                                duration-300
                                hover:scale-[1.09]
                                cursor-pointer
                                '
                    ...
                    >
                        ...
                        {
                            album.map(val => {
                                return <Card key={val._id} info={val} releaseId={releaseId} isPlaying={isPlaying} />
                            })
                        }
