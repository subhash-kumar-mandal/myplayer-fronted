...
import JumpbackCardLoader from './JumpbackCardLoader';
import ReusedLoaderShimmer from '../Globalloaders/ReusedLoaderShimmer';

const JumpBackLoader = () => {
    ...
    return (
        ...
        '>
            ...
            <div className='w-full h-[48px] flex justify-between items-center px-3 '>
               <ReusedLoaderShimmer className='h-8 w-40 rounded-xs' />
               <ReusedLoaderShimmer className='h-6 w-20 rounded-xs' />
            </div>
            ...
            >
                ...
                >
                    ...
                    {
                        new Array(10).fill(0).map((val, index) => <JumpbackCardLoader key={index} />)
                    }
